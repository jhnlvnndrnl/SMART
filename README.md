...
## Features
- **Gamified UI** – Visualize crop health, soil data, and IoT readings  
...
- **feature/** → branches for building new features  
- **fix/** → branches for bug fixes  
- **test/** → branches for system testing before pushing to main

---

## Tech Stack
- **IoT:** Real-time sensor monitoring for crops  
- **Unity:** Gamified 2D simulation for farm management  
